...
function zip(zip_file_name, dist_path) {
  ...
  var parent = path.resolve(dist_path + '/../');
  var dist, parts;
  console.log('dist_path.length', dist_path.length);
  console.log('charAt:', dist_path.charAt(dist_path.length-1))
  console.log('slice', dist_path.slice(0, dist_path.length - 1));
